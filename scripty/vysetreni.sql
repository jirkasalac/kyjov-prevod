...
-- Preparáty = skla, tedy v případě cytologií POC_BS, v případě biopsií POC_BLOKY1. Počet vzorků je zpravidla jeden na vyšetření
...
ISNULL((select MAX(cislo) from winzis_kyjov.dbo.kliniky where winzis_kyjov.dbo.kliniky.icp=vysetreni.IcpZadatele),0) as C_ODESLAL, zaslal as ODESLAL, IcpZadatele as ICP,  OdbZadatele as ODEODB, 
